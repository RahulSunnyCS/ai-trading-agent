...
describe("PositionMonitor dispatch", () => {
  ...
  it("dispatches a 'hold' personality position to HolderManager.evaluatePosition", async () => {
    ...
    const monitor = new PositionMonitor({
      ...
      executor: mockExecutor as unknown as import("../../paper-trade-executor.js").PaperTradeExecutor,
    ...
    expect(evalSpy.mock.calls[0]?.[0]).toMatchObject({ id: "dddddddd-0000-0000-0000-000000000004" });
  ...
  it("dispatches a null personality_id (pre-M2 trade) to HolderManager as default", async () => {
    ...
    expect(evalSpy).toHaveBeenCalledOnce();
    expect(evalSpy.mock.calls[0]?.[0]).toMatchObject({ id: "eeeeeeee-0000-0000-0000-000000000005" });
