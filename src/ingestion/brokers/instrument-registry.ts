 ...
 *
 * Examples:
 *   buildOptionSymbol('NIFTY',    Jan25Expiry, 24500, 'CE') → 'NSE:NIFTY24125 24500CE'
 ...
 *
 * Note: SENSEX is listed on BSE but we still prefix NSE: per the existing
 * symbol convention in types.ts comments. If Fyers changes this, update here.
 */
 ...
 *   future per-underlying expiry calendar differences (e.g. Sensex expiry
 *   moving to Fridays); currently unused because all three expire on Thursday.
