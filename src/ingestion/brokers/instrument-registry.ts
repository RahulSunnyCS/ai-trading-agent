...
// Re-export Underlying so test files can import it from instrument-registry
// (M2 test files use `import { Underlying } from '../instrument-registry.js'`).
...
// ---------------------------------------------------------------------------
// Angel One Token Placeholder (M2 compatibility)
// ---------------------------------------------------------------------------

/**
 * Build a placeholder Angel One instrument identifier for logging/diagnostics.
 * Format: AO:{UNDERLYING}:{STRIKE}:{OPTIONTYPE}:{YYYYMMDD}
 * NEVER pass this to the Angel One API.
 */
