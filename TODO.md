...
| 1.3 | One `workflow_dispatch` run of "Daily broker login" inside 08:15–15:40 IST | owner | Also the first real test that `setup-bun` works inside the Playwright container — it replaced `npm ci` and has never run live. |
